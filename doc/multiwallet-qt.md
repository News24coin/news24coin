...
In order to support loading of multiple wallets in news24coin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is news24coin.cpp.
...
Changes to news24coin.cpp
----------------------
news24coin.cpp is the entry point into news24coin-qt, and as such, will require some minor modifications to provide hooks for
