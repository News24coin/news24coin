...
This mechanism has been integrated into Bitcore-Node-News24coin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/News24coin-Project/insight-api-news24coin#web-socket-api](https://github.com/News24coin-Project/insight-api-news24coin#web-socket-api) 
* API: [https://github.com/News24coin-Project/insight-api-news24coin#swifttx-transactions](https://github.com/News24coin-Project/insight-api-news24coin#swifttx-transactions) 
...
By default, the News24coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the News24coin Core daemon:
