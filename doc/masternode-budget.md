...
News24coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<news24coin_address\> \<monthly_payment_news24coin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ News24coin, _12_ times over the course of a year totaling _24000_ News24coin.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<news24coin_address\> \<monthly_payment_news24coin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` News24coin.
