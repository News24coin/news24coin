...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop News24coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "News24coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* News24coin features */
        {"news24coin", "masternode", &masternode, true, true, false},
        {"news24coin", "listmasternodes", &listmasternodes, true, true, false},
        {"news24coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"news24coin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"news24coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"news24coin", "masternodedebug", &masternodedebug, true, true, false},
        {"news24coin", "startmasternode", &startmasternode, true, true, false},
        {"news24coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"news24coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"news24coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"news24coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"news24coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"news24coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"news24coin", "mnbudget", &mnbudget, true, true, false},
        {"news24coin", "preparebudget", &preparebudget, true, true, false},
        {"news24coin", "submitbudget", &submitbudget, true, true, false},
        {"news24coin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"news24coin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"news24coin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"news24coin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"news24coin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"news24coin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"news24coin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"news24coin", "checkbudgets", &checkbudgets, true, true, false},
        {"news24coin", "mnsync", &mnsync, true, true, false},
        {"news24coin", "spork", &spork, true, true, false},
        {"news24coin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"news24coin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use news24coind, or the -server option to news24coin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> news24coin-cli " + methodname + " " + args + "\n";
}
