...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:9500", "127.0.0.1", 9500));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9500", "127.0.0.1", 9500));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9500", "::ffff:127.0.0.1", 9500));
    BOOST_CHECK(TestSplitHost("[::]:9500", "::", 9500));
    BOOST_CHECK(TestSplitHost("::9500", "::9500", -1));
    BOOST_CHECK(TestSplitHost(":9500", "", 9500));
    BOOST_CHECK(TestSplitHost("[]:9500", "", 9500));
...
{
    CService addr;
    if (!LookupNumeric(src.c_str(), addr, 69500))
        return canon == "";
...
{
    BOOST_CHECK(TestParse("127.0.0.1", "127.0.0.1:69500"));
    BOOST_CHECK(TestParse("127.0.0.1:9500", "127.0.0.1:9500"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:69500"));
    BOOST_CHECK(TestParse("::", "[::]:69500"));
    BOOST_CHECK(TestParse("[::]:9500", "[::]:9500"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:69500"));
