...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total news24coin balance of the wallet\n"
            "  \"obfuscation_balance\": xxxxxx, (numeric) the anonymized news24coin balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in news24coin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in news24coin/kb\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"news24coinaddress\"\n"
            "\nReturn information about the given news24coin address.\n"
            "\nArguments:\n"
            "1. \"news24coinaddress\"     (string, required) The news24coin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"news24coinaddress\", (string) The news24coin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: News24coin address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are news24coin addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) news24coin address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"news24coinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"news24coinaddress\"  (string, required) The news24coin address to use for the signature.\n"
