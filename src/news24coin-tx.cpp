...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("News24coin Core news24coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  news24coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded news24coin transaction") + "\n" +
                               "  news24coin-tx [options] -create [commands]   " + _("Create hex-encoded news24coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded news24coin transaction
