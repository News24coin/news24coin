...
/** Utility functions used by the News24coin Qt UI.
 */
namespace GUIUtil
{
...
// Render News24coin addresses in monospace font
...
// Parse "news24coin:" URI into recipient object, return true on successful parsing
