...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("News24coin Core"),
     ...
     * override -datadir in the news24coin.conf file in the default data directory
     * (to be consistent with news24coind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
