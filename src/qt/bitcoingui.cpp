                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("News24coin") + " ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a News24coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and news24coin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About News24coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about News24coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for News24coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your News24coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified News24coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a News24coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the News24coin Core help message to get a list with possible News24coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("News24coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to News24coin network", "", count));
}
...
{
    QString strTitle = tr("News24coin Core"); // default title
