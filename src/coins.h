...
/** 
    ...
    ****Note - for News24coin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of news24coin coming in to a transaction
