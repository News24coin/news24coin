...
#if defined(NDEBUG)
#error "News24coin cannot be compiled without assertions."
#endif
...
if (nHeight == 0) {
             nSubsidy = 150000 * COIN;
                ...
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 100200) {
                nSubsidy = 24 * COIN;
      } else if (nHeight <= 200000) {
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 200200) {
                nSubsidy = 24 * COIN;
      } else if (nHeight <= 300000) {
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 300200) {
                nSubsidy = 24 * COIN;
      } else if (nHeight <= 400000) {
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 400200) {
                nSubsidy = 24 * COIN;
      } else if (nHeight <= 500000) {
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 502000) {
                nSubsidy = 24 * COIN;
      } else if (nHeight <= 600000) {
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 602000) {
                nSubsidy = 24 * COIN;
      } else if (nHeight <= 700000) {
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 702000) {
                nSubsidy = 24 * COIN;
      } else if (nHeight <= 800000) {
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 802000) {
                nSubsidy = 24 * COIN;
      } else if (nHeight <= 900000) {
                nSubsidy = 2.4 * COIN;
      } else if (nHeight <= 902000) {
                nSubsidy = 24 * COIN;
...
{
    RenameThread("news24coin-scriptch");
