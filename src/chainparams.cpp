...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
        (0, uint256("0x00000d31ebcd2b0dda679390278f01fcba8badfa5deee9f264112462901aab9e"));
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("048317b9dc30175cad81a6fee4d8c62d0f33b7703628a14349790180edfbc297b2dad560c6891d1760d791f226b0b15f0f3776361c01a865e41b2ec05b5d8c2a78");
        nDefaultPort = 9800;
        ...
        const char* pszTimestamp = "FUCKING STUCK CHAIN 16th Sep 2020";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04ce56ca226f9b25055350ba4eab928ff1a5a8361d844ccff7aa550167227faf589133b5b550e92c6658a58e1be3dfdc0d58ca28f6066a185f6892ee024895ef76") << OP_CHECKSIG;
        ...
        genesis.nNonce = 23851254;

        hashGenesisBlock = genesis.GetHash();


        assert(hashGenesisBlock == uint256("0x00000d31ebcd2b0dda679390278f01fcba8badfa5deee9f264112462901aab9e"));
        assert(genesis.hashMerkleRoot == uint256("0xdb3396432bac066857daa5f93fe5d5d50330cd12416f2d51a606daec3cc0cdac"));

        vSeeds.push_back(CDNSSeedData("78.141.209.252", "78.141.209.252"));
        vSeeds.push_back(CDNSSeedData("45.77.66.72", "45.77.66.72"));
        vSeeds.push_back(CDNSSeedData("80.240.25.212", "80.240.25.212"));
        ...
        strSporkKey = "045d53111405764498d149c58a371e347a02c71db7ce2f26a9d37cbd7f06ce987ab03e1b144669f085b643f49a122ef993ce12594227347b60480a8057c2aabe97";
